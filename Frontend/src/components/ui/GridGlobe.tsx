...
// const World = () => import("../ui/global").then((m) => m.World);
...
export function GlobeDemo() {
  ...
  return (
    <div className="flex flex-row items-center justify-center py-20 h-screen md:h-auto  bg-[#000319] relative w-full">
      <div className="max-w-7xl mx-auto w-full relative overflow-hidden h-full md:h-[40rem] px-4">
        ...
        >
          ...
          <img src="https://thealteroffice.com/_next/image?url=%2Fimages%2Falter_office_logo.png&w=640&q=75" alt="logo" className="w-32"/>
          </div>
